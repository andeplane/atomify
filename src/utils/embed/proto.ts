...
export const SimulationData = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          const entry4 = SimulationData_FilesEntry.decode(
            reader,
            reader.uint32(),
          );
  ...
  fromJSON(object: any): SimulationData {
    return {
      ...
      analysisScript: isSet(object.analysisScript)
        ? String(object.analysisScript)
        : undefined,
  ...
  toJSON(message: SimulationData): unknown {
    ...
    message.inputScript !== undefined &&
      (obj.inputScript = message.inputScript);
    message.analysisScript !== undefined &&
      (obj.analysisScript = message.analysisScript);
    obj.files = {};
    if (message.files) {
  ...
  fromPartial<I extends Exact<DeepPartial<SimulationData>, I>>(
    object: I,
  ): SimulationData {
    const message = createBaseSimulationData();
