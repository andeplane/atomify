"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["node_modules_jupyterlab_settingeditor-extension_lib_index_js-_5a051"],{
...
/* harmony import */ var _jupyterlab_settingeditor_lib_tokens__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @jupyterlab/settingeditor/lib/tokens */ 24758);
...
/* harmony import */ var _jupyterlab_statedb__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @jupyterlab/statedb */ 30831);
...
function activate(app, registry, state, translator, editorRegistry, status, restorer, palette, jsonEditor) {
    ...
    const openUi = async (args) => {
        ...
        const key = plugin.id;
        const { SettingsEditor } = await __webpack_require__.e(/*! import() */ "webpack_sharing_consume_default_jupyterlab_settingeditor_jupyterlab_settingeditor").then(__webpack_require__.t.bind(__webpack_require__, /*! @jupyterlab/settingeditor */ 31428, 23));
...
function activateJSON(app, registry, editorServices, state, rendermime, status, translator, restorer, palette) {
    ...
    commands.addCommand(CommandIDs.openJSON, {
        execute: async () => {
            ...
            const { JsonSettingEditor } = await __webpack_require__.e(/*! import() */ "webpack_sharing_consume_default_jupyterlab_settingeditor_jupyterlab_settingeditor").then(__webpack_require__.t.bind(__webpack_require__, /*! @jupyterlab/settingeditor */ 31428, 23));
...
//# sourceMappingURL=node_modules_jupyterlab_settingeditor-extension_lib_index_js-_5a051.1c49dc5.js.map