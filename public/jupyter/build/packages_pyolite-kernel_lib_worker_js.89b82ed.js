...
class PyoliteRemoteKernel {
    ...
    async initRuntime(options) {
        ...
        //@ts-ignore
        window.pyodide = this._pyodide;
        //@ts-ignore
        console.log("Did set it in window ", window.pyodide);
    }
...
//# sourceMappingURL=packages_pyolite-kernel_lib_worker_js.89b82ed.js.map