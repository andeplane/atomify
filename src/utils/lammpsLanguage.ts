...
/**
 * Monaco instance type that supports language registration.
 * This is compatible with both direct monaco-editor imports and @monaco-editor/react loader.
 */
type MonacoInstance = {
  languages: {
    register: (language: Monaco.languages.ILanguageExtensionPoint) => void;
...
/**
 * LAMMPS keywords for Monaco editor syntax highlighting.
 * This includes commands, pair styles, fix styles, compute styles, etc.
 */
...
/**
 * Monaco Monarch tokenizer configuration for LAMMPS syntax highlighting.
 */
const lammpsTokensProvider: Monaco.languages.IMonarchLanguage = {
  keywords: lammpsKeywords,
  typeKeywords: [],
  operators: [
    "=",
    ">",
...
/**
 * Register the LAMMPS language with Monaco editor.
 * Call this function after Monaco has been initialized.
 *
 * @param monaco - The Monaco editor instance
 */
export function registerLammpsLanguage(monaco: MonacoInstance): void {
  monaco.languages.register({ id: "lammps" });
  monaco.languages.setMonarchTokensProvider("lammps", lammpsTokensProvider);
}
