...
/* harmony import */ var _jupyterlab_fileeditor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @jupyterlab/fileeditor */ 11841);
    ...
    async function updateSettings(settings) {
        ...
        if (theme !== 'jupyter' && theme !== 'default') {
            const filename = theme === 'solarized light' || theme === 'solarized dark'
                ? 'solarized'
                : theme;
            await __webpack_require__(49160)(`./${filename}.css`);
        }
...
//# sourceMappingURL=vendors-node_modules_jupyterlab_codemirror-extension_lib_index_js.2241515.js.map