/**
 * The legacy app shell, kept verbatim for embedded mode (ADR-003): the antd
 * Layout/Menu chrome, AutoStartSimulation, the invisible-tabs Main, and the
 * legacy modals. Non-embedded mode renders src/shell/Shell.tsx instead.
 */
