...
/* harmony import */ var _lumino_virtualdom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lumino/virtualdom */ 31334);
...
/* harmony import */ var _lumino_domutils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lumino/domutils */ 33349);
...
/* harmony export */ });
/* harmony import */ var _celldragutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./celldragutils */ 6840);
/* harmony import */ var _collapser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./collapser */ 56883);
/* harmony import */ var _headerfooter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./headerfooter */ 97226);
/* harmony import */ var _inputarea__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inputarea */ 96560);
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model */ 89787);
/* harmony import */ var _placeholder__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./placeholder */ 45544);
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./widget */ 36094);
/* -----------------------------------------------------------------------------
| Copyright (c) Jupyter Development Team.
| Distributed under the terms of the Modified BSD License.
|----------------------------------------------------------------------------*/
...
/* harmony import */ var _jupyterlab_codemirror__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @jupyterlab/codemirror */ 22976);
...
/* harmony import */ var _jupyterlab_attachments__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @jupyterlab/attachments */ 41023);
/* harmony import */ var _jupyterlab_codeeditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @jupyterlab/codeeditor */ 56330);
...
/* harmony import */ var _jupyterlab_shared_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @jupyterlab/shared-models */ 2837);
...
/* harmony import */ var _jupyterlab_outputarea__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @jupyterlab/outputarea */ 38112);
...
const globalModelDBMutex = _jupyterlab_shared_models__WEBPACK_IMPORTED_MODULE_3__.createMutex();
...
/* harmony export */ });
/* harmony import */ var marked__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! marked */ 33079);
/* harmony import */ var _jupyterlab_attachments__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @jupyterlab/attachments */ 41023);
...
/* harmony import */ var _jupyterlab_outputarea__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @jupyterlab/outputarea */ 38112);
...
/* harmony import */ var _jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @jupyterlab/rendermime */ 60213);
...
/* harmony import */ var _lumino_algorithm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @lumino/algorithm */ 43892);
...
/* harmony import */ var _lumino_polling__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @lumino/polling */ 61313);
...
/* harmony import */ var _collapser__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./collapser */ 56883);
/* harmony import */ var _headerfooter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./headerfooter */ 97226);
/* harmony import */ var _inputarea__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./inputarea */ 96560);
/* harmony import */ var _placeholder__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./placeholder */ 45544);
/* harmony import */ var _resizeHandle__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./resizeHandle */ 93128);
/* -----------------------------------------------------------------------------
| Copyright (c) Jupyter Development Team.
| Distributed under the terms of the Modified BSD License.
|----------------------------------------------------------------------------*/
 ...
 * A base cell widget.
 */
class Cell extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_9__.Widget {
    /**
     * Construct a new base cell widget.
     */
    constructor(options) {
        super();
        this._displayChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_8__.Signal(this);
        this._readOnly = false;
        this._inputHidden = false;
        this._syncCollapse = false;
        this._syncEditable = false;
        this._resizeDebouncer = new _lumino_polling__WEBPACK_IMPORTED_MODULE_7__.Debouncer(() => {
        ...
        this.layout = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_9__.PanelLayout();
        // Header
        const header = contentFactory.createCellHeader();
        header.addClass(CELL_HEADER_CLASS);
        this.layout.addWidget(header);
        // Input
        const inputWrapper = (this._inputWrapper = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_9__.Panel());
        inputWrapper.addClass(CELL_INPUT_WRAPPER_CLASS);
        const inputCollapser = new _collapser__WEBPACK_IMPORTED_MODULE_10__.InputCollapser();
        inputCollapser.addClass(CELL_INPUT_COLLAPSER_CLASS);
        const input = (this._input = new _inputarea__WEBPACK_IMPORTED_MODULE_11__.InputArea({
            model,
            contentFactory,
        ...
        this._inputPlaceholder = new _placeholder__WEBPACK_IMPORTED_MODULE_12__.InputPlaceholder(() => {
...
(function (Cell) {
    ...
    class ContentFactory {
        ...
        constructor(options = {}) {
            this._editorFactory =
                options.editorFactory || _inputarea__WEBPACK_IMPORTED_MODULE_11__.InputArea.defaultEditorFactory;
        }
        /**
         ...
         */
        createCellHeader() {
            return new _headerfooter__WEBPACK_IMPORTED_MODULE_13__.CellHeader();
        }
        /**
         * Create a new cell header for the parent widget.
         */
        createCellFooter() {
            return new _headerfooter__WEBPACK_IMPORTED_MODULE_13__.CellFooter();
        }
        /**
         * Create an input prompt.
         */
        createInputPrompt() {
            return new _inputarea__WEBPACK_IMPORTED_MODULE_11__.InputPrompt();
        }
        /**
...
class CodeCell extends Cell {
    ...
    constructor(options) {
        ...
        if (!options.placeholder) {
            ...
            const outputWrapper = (this._outputWrapper = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_9__.Panel());
            outputWrapper.addClass(CELL_OUTPUT_WRAPPER_CLASS);
            const outputCollapser = new _collapser__WEBPACK_IMPORTED_MODULE_10__.OutputCollapser();
            ...
            this.layout.insertWidget(2, new _resizeHandle__WEBPACK_IMPORTED_MODULE_14__.ResizeHandle(this.node));
            this.layout.insertWidget(3, outputWrapper);
            if (model.isDirty) {
                this.addClass(DIRTY_CLASS);
            }
            this._outputPlaceholder = new _placeholder__WEBPACK_IMPORTED_MODULE_12__.OutputPlaceholder(() => {
...
class AttachmentsCell extends Cell {
    ...
    _evtDragOver(event) {
        const supportedMimeType = (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_6__.some)(_jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_3__.imageRendererFactory.mimeTypes, mimeType => {
     ...
     */
    _evtDrop(event) {
        const supportedMimeTypes = (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_6__.toArray)((0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_6__.filter)(event.mimeData.types(), mimeType => {
    ...
    _generateURI(name = '') {
        ...
        return lastIndex !== -1
            ? _lumino_coreutils__WEBPACK_IMPORTED_MODULE_5__.UUID.uuid4().concat(name.substring(lastIndex))
            : _lumino_coreutils__WEBPACK_IMPORTED_MODULE_5__.UUID.uuid4();
    }
}
/** ****************************************************************************
 * MarkdownCell
...
class MarkdownCell extends AttachmentsCell {
    ...
    constructor(options) {
        var _a, _b, _c;
        super(options);
        this._toggleCollapsedSignal = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_8__.Signal(this);
        this._renderer = null;
        this._rendered = true;
        this._prevText = '';
        ...
        this._rendermime = options.rendermime.clone({
            resolver: new _jupyterlab_attachments__WEBPACK_IMPORTED_MODULE_15__.AttachmentsResolver({
    ...
    maybeCreateOrUpdateExpandButton() {
        ...
        if (this.headingCollapsed &&
            ...
            _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_4__.addIcon.render(numberChildNodes);
...
//# sourceMappingURL=vendors-node_modules_jupyterlab_cells_lib_index_js.9e8189f.js.map