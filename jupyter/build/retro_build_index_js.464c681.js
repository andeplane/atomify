...
async function main() {
  ...
  let baseMods = [
    ...
    (__webpack_require__(/*! @jupyterlab/notebook-extension */ 61402)["default"].filter)(({ id }) =>
      [
  ...
  switch (page) {
    ...
    case 'notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(/*! @jupyterlab/cell-toolbar-extension */ 52577),
        (__webpack_require__(/*! @jupyterlab/completer-extension */ 69020)["default"].filter)(({ id }) =>
    ...
    case 'edit': {
      baseMods = baseMods.concat([
        ...
        (__webpack_require__(/*! @jupyterlab/fileeditor-extension */ 53630)["default"].filter)(({ id }) =>
...
//# sourceMappingURL=retro_build_index_js.464c681.js.map